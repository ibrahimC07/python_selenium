...
from ssqatest.ssqatest.src.pages.locators.ProductPageLocators import ProductPageLocators
from ssqatest.ssqatest.src.helpers.config_helpers import get_base_url
